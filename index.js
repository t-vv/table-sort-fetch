...
const mainWrap = (function() {
  function _accessAccount() {
    // Sorting Data Table
    function dataFinancial(e) {
    ...
    function getMoreFinData() {
      ...
      fetch(request)
        ...
        .then(data => {
          ...
          data.finData.map(function(finDetails, i, finArr) {
    ...
    // Event Listeners
    document.querySelector(".get-more").addEventListener("click", function(e) {
      getMoreFinData();
    });
